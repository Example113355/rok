...
const Privacy = () => {
    return (
        <div className="privacy">
            <Breadcrumb />
            <h1 className="privacy-header">Chính sách bảo mật và đền bù</h1>

            <div className="privacy-paragraph">
                <h2 className="privacy-paragraph-header">Chúng tôi là ai?</h2>
                <p>
                    <strong>Văn bản được đề xuất: </strong>
                    Địa chỉ website là: https://kamiautobot.com.
                </p>
            </div>

            <div className="privacy-paragraph">
                <h2 className="privacy-paragraph-header">Bình luận</h2>
                <p>
                    <strong>Văn bản được đề xuất: </strong>
            ...
            <div className="privacy-paragraph">
                <h2 className="privacy-paragraph-header">Media</h2>
                <p>
                    <strong>Văn bản được đề xuất: </strong>
            ...
            <div className="privacy-paragraph">
                <h2 className="privacy-paragraph-header">Nội dung nhúng từ website khác</h2>
                <p>
                    <strong>Văn bản được đề xuất: </strong>
            ...
            <div className="privacy-paragraph">
                <h2 className="privacy-paragraph-header">Chúng tôi chia sẻ dữ liệu của bạn với ai</h2>
                <p>
                    <strong>Văn bản được đề xuất: </strong>
            ...
            <div className="privacy-paragraph">
                <h2 className="privacy-paragraph-header">Dữ liệu của bạn tồn tại bao lâu</h2>
                <p>
                    <strong>Văn bản được đề xuất: </strong>
            ...
            <div className="privacy-paragraph">
                <h2 className="privacy-paragraph-header">Các quyền nào của bạn với dữ liệu của mình</h2>
                <p>
                    <strong>Văn bản được đề xuất: </strong>
            ...
            <div className="privacy-paragraph">
                <h2 className="privacy-paragraph-header">Chính sách đền bù</h2>
                <p>
                    <strong>Văn bản được đề xuất: </strong>
                    Trong thời gian sử dụng dịch vụ, trường hợp bị nhà phát hành hạn chế tài khoản sẽ được nhận đề bù như sau:
                </p>
                <p>
                Thời hạn hạn chế 1 ngày đến 3 ngày sẽ được đền bù số ngày không thể sử dụng dịch vụ, cộng dồn cho lần sử dụng tiếp theo. Thời hạn hạn chế 365 ngày (1 năm) hoặc hạn chế vĩnh viễn, nhà phát hành bot sẽ nhận lại tài khoản đó, và đền bù 100% giá trị tài khoản bị hạn chế. 
                <br></br>
                Giá trị tài khoản sẽ được người có chuyên môn nhất định thẩm định (những nhà bán lẻ tài khoản đang hoạt động trên thị trường)
                <br></br>
                ※Bảo hành đền bù giá trị tài khoản chỉ áp dụng cho gói vip 3.
                </p>
            </div>
        </div>
    )
